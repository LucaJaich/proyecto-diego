            ...
            <div class="w3-third">
                <div class="w3-card-4 w3-margin">
                    ...
                    <table class="w3-table-all">
                        <tr>
                            <th class="w3-button w3-center"><a href="grupo.php?id=1A-2018" style="display:block;text-decoration:none;color:#333;"><i class="fas fa-users w3-large"></i> 1A-2018</a></th>
                        </tr>
                        <tr>
            ...
            <div class="w3-third">
                <div class="w3-card-4 w3-margin">
                    ...
                    <table class="w3-table-all">
                        ...
                        <tr>
                            <th class="w3-button w3-center"><a href="grupo.php?id=2B-2018" style="display:block;text-decoration:none;color:#333;"><i class="fas fa-users w3-large"></i> 2B-2018<a/></th>
                        </tr>
                        <tr>
